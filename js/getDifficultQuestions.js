var difficultQuestionLayer;

function removeDifficultQuestions() {
    alert("5 Most difficult Quiz Questions will be removed");
    mymap.removeLayer(difficultQuestionLayer);
};
...
// load the geoJSON layer
    difficultQuestionLayer = L.geoJson(result,
        {       
